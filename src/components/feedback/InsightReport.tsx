...
export function InsightReport({ report, answers, onRequestDemo }: Props) {
  ...
  return (
    <div className="animate-scale-in space-y-8">
      ...
      {report.keyThemes && Object.keys(report.keyThemes).length > 0 && (
        <div className="space-y-3">
          <h2 className="text-lg font-heading font-bold text-foreground">💡 Key Themes from Your Responses</h2>
      ...
      <div className="p-6 rounded-xl border border-primary/20 bg-primary/5 text-center space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
          ...
          <button
            ...
            className="px-6 py-3 rounded-xl border border-border bg-secondary text-foreground font-heading font-semibold hover:border-primary/30 transition-all"
          >
            📄 Save as PDF
          </button>
        </div>
